...
public class StatisticsController extends BaseController {
  ...
  public AjaxResult getCollectionTotalAndNotStudyNum(
      @RequestParam("wordCollectionId") String collectionUUId) {
    return AjaxResult.success(
        statisticsService.getCollectionTotalAndNotStudyNum(collectionUUId, this.getUserId()));
  }
