 ...
 */
@Service
public class PackageCardRefServiceImpl extends ServiceImpl<PackageCardRefMapper, PackageCardRef> implements PackageCardRefService {
    ...
    public List<PackageInfoDto> getPackagesByCardUUId(String cardUUId) {
        ...
        List<String> packageUUIdList = packageCardRefList.stream()
                .map(PackageCardRef::getPackageUuid)
        ...
        List<FlashcardPackage> flashcardPackages = flashcardPackageService.list(flashcardPackageQueryWrapper);
