 ...
 */
@Service
public class WordSentenceServiceImpl extends ServiceImpl<WordSentenceMapper, WordSentence> implements IWordSentenceService {
    @Override
    ...
    public AjaxResult addSentenceOfWord(WordSentenceDto wordSentenceDto) {
        ...
        wordSentenceDto.getSentenceDtoList().forEach(e -> {
            ...
            wordSentence.setSentenceContent(e.getSentenceContent())
                    .setTranslateContent(e.getTranslateContent())
                    .setWordUuid(wordSentenceDto.getWordUUId())
    ...
    public AjaxResult editSentenceOfWord(WordSentenceDto wordSentenceDto) {
        ...
        List<SentenceDto> addSentenceDtoList = wordSentenceDto.getSentenceDtoList().stream()
                .filter(e -> StringUtils.isBlank(e.getUuid()))
        ...
        Map<String, WordSentence> sentenceMap = sentenceList.stream()
                .collect(Collectors.toMap(WordSentence::getUuid, Function.identity()));
        // 对修改的进行处理
        List<WordSentence> updateupdateSentenceList = new ArrayList<>();
        wordSentenceDto.getSentenceDtoList().stream()
