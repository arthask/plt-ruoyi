...
public class StatisticsServiceImpl implements IStatisticsService {
    ...
    public Map<String, Long[]> getExceptAndActualValueOfDay(Long userId) {
        ...
        // 当天单词学习记录
        Map<String, Map<String, Long>> actualValueOfDay = userStudyRecordMapper
                .getActualValueOfDay(userId, DateUtil.format(beginOfMonth, DateUtils.YYYY_MM_DD_HH_MM_SS),
                DateUtil.format(endOfMonth, DateUtils.YYYY_MM_DD_HH_MM_SS));
